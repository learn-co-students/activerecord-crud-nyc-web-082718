...
def can_be_found_updated_and_saved
  ...
  Movie.all.find_by(title: "Awesome Flick").update(title: "Even Awesomer Flick")
  Movie.all.find_by(title: "Even Awesomer Flick")
...
def can_update_multiple_items_at_once
    ...
    Movie.all.update(title: "A Movie", release_date: 2000)
end
